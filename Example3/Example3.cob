...
000167     		   END-IF
000168*******OLD??????=??????????******     		   
000169     		   IF ID-P = ID-DATA THEN
000170     		   	   MOVE "T" TO CHECK-DATA-USE
000171     		       PERFORM WRITE-LIST-PRODUCT
000172     		       PERFORM WRITE-NEW-PRODUCT
000173     		       PERFORM PRODUCT-INPUT
000174     		       PERFORM DATA-INPUT
000175     		   END-IF
000176*******OLD??????>??????????*****     		   
000177     		   IF ID-P > ID-DATA THEN
000178     		   		PERFORM WRITE-LIST-DATA		
000179     		   		PERFORM DATA-INPUT
000180     		   END-IF
000181     		   
000182     		END-IF
000183     		   
