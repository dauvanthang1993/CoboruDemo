...
001900  01  Ｗ－基本給      PIC   9(8).
002000 LINKAGE SECTION.
002100  01  Ｌ－総支給          PIC   9(8).
002200 PROCEDURE   DIVISION    RETURNING   Ｌ－総支給.
002300*
002400     INVOKE  SUPER  "Salary-method"  RETURNING  Ｗ－基本給.
002500     COMPUTE  Ｌ－総支給  =
002600              Ｗ－基本給  +  (残業時間  *  時間外手当).
002700*
