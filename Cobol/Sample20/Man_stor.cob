000010*========================================================================
000020*　管理保存メソッド   　   －サンプルプログラム「従業員管理（永続化）」－
000030*
000040*　　　SELFオブジェクトが保持する管理者従業員に固有なデータを，従業員マ
000050*　　スタクラスのファクトリデータに設定する．
000060*　　　SUPER クラスのデータ保存メソッドを呼びだす。
000070*
000080*　〇参照クラス
000090*　　１）従業員マスタクラス  （MemberMaster-class）
000100*    ２）管理者クラス　　　　（Manager-class）　　　　　←所属クラス
000110*
...
000240*
000250     MOVE   特別手当  TO  特別手当  OF  MemberMaster-class.
