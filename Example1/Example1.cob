...
000105 		02 COUNT-REOFPAGE PIC 9(2) VALUE ZERO.
000106
...
000235	   		COMPUTE COUNT-REOFPAGE = COUNT-REOFPAGE + 1
...
000323 		IF COUNT-REOFPAGE = 10 THEN
000324	       MOVE 0 TO COUNT-REOFPAGE
